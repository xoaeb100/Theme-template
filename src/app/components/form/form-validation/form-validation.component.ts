...
export class FormValidationComponent implements OnInit {
  ...
  public inputValidationForm!: FormGroup
  ...
  constructor(private fb: FormBuilder,
    ...
    get inputValidationControl(){
      return this.inputValidationForm.controls;
    }
    ...
    validationSubmit() {
      if (this.inputValidationForm.valid) {
        this.toast.success("Successfully Submitted", "Done!");
      } else if (this.inputValidationForm.invalid) {
