...
@NgModule({
  declarations: [HeaderComponent, FooterComponent, SidemenuComponent, TapToTopComponent,
                LoaderComponent, NotificationSidebarComponent, FullLayoutComponent, ContentLayoutComponent,
                FullscreenDirective, HoriFullLayoutComponent, HoriHeaderComponent, HoriMenuComponent],
  imports: [
    CommonModule,
    RouterModule,
    NgbModule,
